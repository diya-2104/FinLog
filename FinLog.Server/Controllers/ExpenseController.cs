...
namespace FinLog.Server.Controllers
{
    ...
    public class ExpenseController : ControllerBase
    {
        ...
        // ========================================
        // FIXED: Log Transaction (using cid instead of ref_id)
        // ========================================
        private async Task LogTransaction(int uid, int account_id, int cid, decimal amount, string ttype, string? description = null, DateTime? createdAt = null)
        {
        ...
        // ========================================
        // GET: api/expense/categories/user/{uid}
        // ========================================
        ...
        public async Task<IActionResult> DeleteExpense(int id)
        {
            ...
            // Log negative transaction (FIXED)
            await LogTransaction(
                expense.uid,
                expense.account_id,
                expense.cid,                      // FIXED
        ...
        // ========================================
        // GET: api/expense/accounts/user/{uid}
        // ========================================
        ...
        // ========================================
        // GET: api/expense/monthly-bills/{uid}
        // ========================================
